    ...
    click () {
      ...
      if (this.expand) {
        ...
        for (const el of this.$el.querySelectorAll('.van-calendar__day')) {
          ...
          if (el.parentNode.parentNode !== selectedNode.parentNode.parentNode && el.getBoundingClientRect().top !== selectedNode.getBoundingClientRect().top) {
            addClass(el, 'hidden')
          } else if (el.getBoundingClientRect().top !== selectedNode.getBoundingClientRect().top) {
